...
global R T Tc co C1 beta phicrit H pfinal xi xmax tcar phimax Fc F1 F2 cg dl;
...
xi=0.25; %initial fraction of crystals (not yet included to estimate density)
